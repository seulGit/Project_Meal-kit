...
$(function () {
    $.ajax({
        ...
        success: function (data) {
            ...
            //서브이미지 클릭 시 메인사진변경 기능 & 마우스아웃 시 메인사진으로 다시 돌아가는 기능
            //이미지 div 요소 가져오기
            ...
            //서브이미지div에서 마우스아웃 시 메인사진으로 다시 보이는 기능 
            subImgBox.addEventListener('mouseout', function () { // 서브이미지 담고있는 div로부터 마우스가 밖으로 나가면 
